...
const Footer = () => {
  return (
    <footer id='fbg' className="border-t border-t-gray-200 py-8">
      <div id='fbg' className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold">HireHub</h2>
            <p className="text-sm">© 2024 HireHub. All rights are reserved.</p>
          </div>
